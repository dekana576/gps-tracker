    ...
    <main class="container mx-auto py-5">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300" style="margin: 20px">
             <div class="flex items-center">
                ...
                <h2 class="ml-4 text-lg font-semibold text-blue-600" style="text-shadow: none;">List User</h2>
            </div>
                <p class="mt-2 text-sm text-gray-600" style="text-shadow: none;">Kelola daftar pengguna di aplikasi Anda.</p>
            ...
            <div class="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300" style="margin: 20px">
             <div class="flex items-center">
                ...
                <h2 class="ml-4 text-lg font-semibold text-blue-600" style="text-shadow: none;">History Tracking</h2>
            </div>
                <p class="mt-2 text-sm text-gray-600" style="text-shadow: none;">Pantau data aktivitas pengguna secara real-time.</p>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition duration-300" style="margin: 20px">
             <div class="flex items-center">
                ...
                <h2 class="ml-4 text-lg font-semibold text-blue-600" style="text-shadow: none;">Download Laporan</h2>
            </div>
                <p class="mt-2 text-sm text-gray-600" style="text-shadow: none;">Unduh laporan dalam format PDF atau Excel.</p>
